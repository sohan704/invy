import { FaFacebook, FaInstagram, FaSnapchat, FaTools, FaTwitter, FaYoutube } from "react-icons/fa";

const Footer = () => {
  return (
    <div>
      <footer className="footer grid-rows-2 text-lg p-10 bg-white text-black">
        <nav>
